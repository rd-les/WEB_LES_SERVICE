...
namespace Web_LED.App_Class {
    public class ClassDataBase {
        ...
        public ClassDataBase(string connString) {
        ...
        private SqlConnection connectionDB(string connectionString ) {
            try {
        ...
        private SqlConnection getConnection() {
            ...
            //connectionString = "Server=192.168.18.100;Uid=sa;PASSWORD=LED123456!;database=LED_FIRST;Max Pool Size=400;Connect Timeout=600;"; //FOR SERVER
            ...
            return this.connectionDB(connectionString); 
        }
